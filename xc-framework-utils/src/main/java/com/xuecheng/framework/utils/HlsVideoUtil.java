...
public class HlsVideoUtil extends  VideoUtil {
    ...
    String m3u8folder_path = "f:/BaiduNetdiskDownload/Movies/test1/";
...
//        commend.add("f:/BaiduNetdiskDownload/Movies/test1/test1_%05d.ts");
        commend.add(m3u8folder_path  + m3u8_name.substring(0,m3u8_name.lastIndexOf(".")) + "_%05d.ts");
//        commend.add("f:/BaiduNetdiskDownload/Movies/test1/test1.m3u8");
